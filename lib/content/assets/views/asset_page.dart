...
import 'package:kibasi/content/assets/controllers/asset_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            _assetIndex == Constants.BUS_ASSET
                ? Get.to(EditBusPage())
                : Get.to(EditDriverPage());
          }),
        ...
        itemBuilder: (context, int index) {
          return ChoiceChip(
            ...
            onSelected: (bool selected) {
              setState(() {
                _assetIndex = selected ? index : Constants.BUS_ASSET;
              });
            },
            backgroundColor: color.AppColor.paleBlue,
